...
// this list should hold all the coupons that the company manufactured.		
		return coupons;
	}
// for the coupons list we want a function that inputs the coupons in a controlled way."couponSelector".
}
